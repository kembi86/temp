...
$a = \modava\temp\assets\TempAsset::register($this);
    ...
    <div class="hk-pg-wrapper hk-auth-wrapper">
        <header class="d-flex justify-content-between align-items-center">
            <a class="d-flex auth-brand" href="#">
                <img class="brand-img" src="<?= Url::to($this->assetManager->publish('@tempweb/dist/img/site-logo.png')[1]); ?>" alt="brand"/>
            </a>
                ...
                <div class="col-xl-5 pa-0">
                    <div id="owl_demo_1" class="owl-carousel dots-on-item owl-theme">
                        <div class="fadeOut item auth-cover-img overlay-wrap"
                             style="background-image:url(<?= Url::to($this->assetManager->publish('@tempweb/dist/img/bg2.png')[1]); ?>);">
                        ...
                        <div class="fadeOut item auth-cover-img overlay-wrap"
                             style="background-image:url(<?= Url::to($this->assetManager->publish('@tempweb/dist/img/bg1.png')[1]); ?>);">
                            <div class="auth-cover-info py-xl-0 pt-100 pb-50">
                                <div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
                        ...
                        <div class="fadeOut item auth-cover-img overlay-wrap"
                             style="background-image:url(<?= Url::to($this->assetManager->publish('@tempweb/dist/img/bg3.png')[1]); ?>);">
                            <div class="auth-cover-info py-xl-0 pt-100 pb-50">
                                <div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
                        ...
                        <div class="fadeOut item auth-cover-img overlay-wrap"
                             style="background-image:url(<?= Url::to($this->assetManager->publish('@tempweb/dist/img/bg4.png')[1]); ?>);">
                            <div class="auth-cover-info py-xl-0 pt-100 pb-50">
                                <div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
                ...
                <div class="col-xl-7 pa-0">
                    <div class="auth-form-wrap py-xl-0 py-50">
                        <div class="auth-form w-xxl-65 w-xl-75 w-sm-90 w-100 card pa-25 shadow-lg">
                            <form>
                                <h1 class="display-4 mb-10"><?=\modava\temp\Temp::t('login', 'Welcome Back'); ?> :)</h1>
                                <p class="mb-30"><?=\modava\temp\Temp::t('login', 'Sign in to your account and enjoy unlimited perks'); ?></p>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Email" type="email">
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <input class="form-control" placeholder="<?=\modava\temp\Temp::t('login', 'Password'); ?>" type="password">
                                ...
                                <div class="custom-control custom-checkbox mb-25">
                                    ...
                                    <label class="custom-control-label font-14" for="same-address">
                                        <?=\modava\temp\Temp::t('login', 'Keep me logged in'); ?></label>
                                </div>
                                <button class="btn btn-success btn-block" type="submit">Login</button>
                                <p class="font-14 text-center mt-15"><?=\modava\temp\Temp::t('login', 'Having trouble logging in'); ?>?</p>
                                <div class="option-sep"><?=\modava\temp\Temp::t('login', 'or'); ?></div>
                                <div class="form-row">
                                    <div class="col-sm-6 mb-20">
                                        <button class="btn btn-indigo btn-block btn-wth-icon"><span
                                                    class="icon-label"><i class="fa fa-facebook"></i> </span><span
                                                    class="btn-text"><?=\modava\temp\Temp::t('login', 'Login with facebook'); ?></span></button>
                                    </div>
                                    <div class="col-sm-6 mb-20">
                                        <button class="btn btn-primary btn-block btn-wth-icon"><span
                                                    class="icon-label"><i class="fa fa-twitter"></i> </span><span
                                                    class="btn-text"><?=\modava\temp\Temp::t('login', 'Login with Twitter'); ?></span></button>
                                    </div>
                                </div>
                                <p class="text-center"><?=\modava\temp\Temp::t('login', 'Do have an account yet'); ?>? <a href="#"><?=\modava\temp\Temp::t('login', 'Sign Up'); ?></a></p>
                            </form>
                        </div>
                    </div>
                </div>
